...
![Build](https://github.com/AkshayAshokCode/Build-Time-Tracker-Plugin/workflows/Build/badge.svg)
...
- Manually:
  ...
  Download the [latest release](https://github.com/AkshayAshokCode/Build-Time-Tracker-Plugin/releases/latest) and install it manually using
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>⚙️</kbd> > <kbd>Install plugin from disk...</kbd>
